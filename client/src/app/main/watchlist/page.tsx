...
export default function Watchlist() {
    ...
    const [newsletterFormData, setNewsletterFormData] =
        useState<SearchModalData>(defaultSearchModalData);
        ...
        <div className="l-watchlist">
            ...
            <div className="l-watchlist__actions">
                <div className="l-watchlist__actions--left">
                    <Button variant="outlined" startIcon={<Plus />} onClick={handleOpenSearchModal}>
                        Add stock
                    </Button>
                </div>
                ...
                <div className="l-watchlist__actions--right">
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', justifyContent: 'flex-end', marginRight: '1rem' } }}>
                        <Button variant="contained" startIcon={<Plus />} onClick={handleOpenSearchModal}>
                            New Portfolio
                        </Button>
                    </Box>
                </div>
            </div>
            <div className="l-watchlist__table"></div>
