...
// export default function ButtonAppBar({ navProps }: ButtonAppBarProps) {
//     const listItems = navProps.map(header =>
//         <Button size="small" LinkComponent="a" sx={{ flexGrow: 1, color: 'black'}} key={header.title} href={header.url} >
//           {header.title}
//         </Button>
//       );
//     return (
...
//                     </IconButton>
//                     {listItems}
//                     <Button variant='contained' sx={{ bgcolor: 'black', color: '#fff'}}>Login</Button>
//                 </Toolbar>
//             </AppBar>
//         </Box>
//     );
...
import reactLogo from '../../assets/logo/logo.svg';
import { alpha, InputBase, styled } from '@mui/material';
import SearchIcon from '@mui/icons-material/Search';

const pages = ['Scanner', 'Watchlist', 'Chart', 'support'];
